...
- For retained-photo generation on Windows, the bundled sanitizer requires Windows PowerShell and `System.Drawing`. On other systems, supply an already sanitized image or an equivalent locally verified sanitizer.
...
This repository contains no upstream brand assets, source or example photographs, or upstream finished/generated images. It distributes text instructions, configuration, and source code only.
